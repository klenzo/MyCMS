<?php
	define('identif_icorrect', 'Identifiant incorrect');
	define('login_lost', 'Identifiant ou mot de passe incorrect');
	define('INFO_LOGIN', 'Veuillez entrez vos informations de connexion.');

<aside class="aside col-2 float-<?= getConfig('aside_pos'); ?>">
	...
	<ul class="navAdmin">
		<li class="liAside"><a href="/" class="linkNavAdmin active"><i class="fa fa-tachometer iconAside"></i><?= W_PANEL; ?></a></li>
		<li class="liAside"><a href="/pages" class="linkNavAdmin"><i class="fa fa-file iconAside"></i><?= W_PAGES; ?></a>
			<ul class="subAside">
				<a href="/pages/add" class="sub-linkNavAdmin"><i class="fa fa-plus iconAside"></i><?= W_ADD; ?></a>
			</ul>
		</li>
		<li class="liAside"><a href="/messages" class="linkNavAdmin"><i class="fa fa-comments iconAside"></i><?= W_MESSAGES; ?></a>
			<ul class="subAside">
		...
		<li class="liAside"><a href="/users" class="linkNavAdmin"><i class="fa fa-users iconAside"></i><?= W_USERS; ?></a>
			<ul class="subAside">
		...
		<li class="liAside"><a href="/addons" class="linkNavAdmin"><i class="fa fa-puzzle-piece iconAside"></i><?= W_PLUGINS; ?></a>
			<ul class="subAside">
